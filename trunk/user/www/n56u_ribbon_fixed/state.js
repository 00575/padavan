...
function show_banner(L3){
	...
	bc += '    <td><button type="button" id="shellinabox_btn" class="btn btn-mini btn-success" style="width: 114px; height: 21px; outline:0; '+enabledBtnshellinabox+'" onclick="button_shellinabox();">Web shell</button>&nbsp;<button type="button" id="logout_btn" class="btn btn-mini" style="height: 21px; outline:0;" title="<#BTN_LOGOUT#>" onclick="logout();"><i class="icon icon-refresh"></i></button>&nbsp;<button type="button" id="reboto_btn" class="btn btn-mini" style="height: 21px; outline:0;" title="<#BTN_REBOOT#>" onclick="reboot();"><i class="icon icon-off"></i></td>\n';
	bc += '  </tr>\n';
	bc += '</table>\n';
	bc += '</div>\n';
	bc += '</div>\n';
