...
function change_reboot_mode_bridge(){
	var m = document.form.reboot_mode.value;
	var is_reboot_mode = (m == "1") ? 1 : 0;
	showhide_div("reboot_mode_tr", is_reboot_mode);
}
                        ...
                        <div class="box well grad_colour_dark_blue">
                            ...
                            <div class="round_bottom">
                                <div class="row-fluid">
                                    ...
                                    <div class="alert alert-info" style="margin: 10px;"><#Adm_System_desc#>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" id="shutdown_btn" class="btn btn-danger" style="min-width: 50px;" onclick="shutdown();"> <i class="icon icon-ban-circle"></i> 关机</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" id="shutdown_btn" class="btn btn-danger" style="min-width: 50px;" onclick="reboot();"> <i class="icon icon-off"></i> 重启</button></div>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        ...
                                        <tr>
                                            <th>手动设置时间:</th>
                                            <td>
                                                <input type="text" maxlength="19"  class="input" size="60" id="time_system" name="time_system" placeholder="2016-8-10 21:33:55" value="<% nvram_get_x("","time_system"); %>" onKeyPress="return is_string(this,event);" />
                                            </td>
                                        </tr>
                                    </table>
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <th colspan="4" style="background-color: #E3E3E3;">定时重启</th>
                                        </tr>
                                        <tr>
                                            <th  width="50%">定时重启</a></th>
                                            <td>
                                                <select name="reboot_mode" class="input" onChange="change_reboot_mode_bridge();">
                                                    <option value="0" <% nvram_match_x("","reboot_mode", "0","selected"); %>>关闭</option>
                                                    <option value="1" <% nvram_match_x("","reboot_mode", "1","selected"); %>>每天</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr id="reboot_mode_tr" style="display:none;">
                                            <th  width="50%">重启时间:</a></th>
                                            <td>
                                                    <input type="text" maxlength="2" class="input" size="10" name="reboot_hour" style="width: 24px;"  value="<% nvram_get_x("","reboot_hour"); %>" onkeypress="return is_number(this,event);"/> 时：<input type="text" maxlength="2" class="input" size="10" name="reboot_minute" style="width: 20px;"  value="<% nvram_get_x("","reboot_minute"); %>" onkeypress="return is_number(this,event);"/>分
                                            </td>
                                        </tr>
