	...
	if(document.form.wl_macmode.value == "allow"){
		if(document.form.wl_macnum_x_0.value < 1){
			if(confirm("<#FirewallConfig_MFList_accept_hint1#>")){
				...
				markGroupACL(document.form.ACLList2, 64, ' Add ');
				document.form.submit();
			}
			else
				return false;
...
function showACLList(){
	...
	if(ACLList.length == 0) {
		...
		code += '<td><button class="btn btn-danger" type="submit" onclick="return markGroupACL(this, 64, \' Del \');" name="ACLList"><i class="icon icon-minus icon-white"></i></button></td>';
		code += '</tr>'
	}
                                ...
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table table-list" id="ACLList_Block">
                                        ...
                                        <tr>
                                            ...
                                            <td width="5%">
                                                <button class="btn" style="max-width: 219px" type="submit" onclick="return markGroupACL(this, 64, ' Add ');" name="ACLList2" value="<#CTL_add#>" size="12"><i class="icon icon-plus"></i></button>
                                            </td>
                                        </tr>
                                    </table>
