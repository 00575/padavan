...
<div class="wrapper">
    ...
    <input type="hidden" name="sid_list" value="Storage;LANHostConfig;General;">
                                    ...
                                    <table width="100%" id="tbl_aria" cellpadding="4" cellspacing="0" class="table" style="display:none;">
                                        ...
                                        <tr id="row_aria_ssl">
                                            ...
                                            <td colspan="2">
                                                ...
                                                <div style="position: absolute; margin-left: -10000px;">
                                                    <input type="radio" name="aria_ssl" id="aria_ssl_1" value="1" <% nvram_match_x("", "aria_ssl", "1", "checked"); %>/><#checkbox_Yes#>
                                                    <input type="radio" name="aria_ssl" id="aria_ssl_0" value="0" <% nvram_match_x("", "aria_ssl", "0", "checked"); %>/><#checkbox_No#>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr id="row_aria_pport">
                                            ...
                                            <td>
                                               <a href="" id="web_aria_3link" style="display:none;">Web control</a>
                                            </td>
                                        </tr>
