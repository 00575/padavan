...
//	if(validForm()){
		...
		document.form.current_page.value = "/Advanced_Extensions_aliddns.asp";
...
<div class="wrapper">
	...
	<input type="hidden" name="current_page" value="Advanced_Extensions_aliddns.asp">
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box well grad_colour_dark_blue">
							<h2 class="box_head round_top">Aliddns 域名解析</h2>
